  ...
  include_once("connect.php"); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="view_faq.php">Testimonial</a><span class="divider">/</span>
					</li>
					<li>
						<a href="add_faq.php">Add Tesstimonial</a>
					</li>
				</ul>
			</div>
			<a href="view_faq.php">Testimonials</a> 
			...
			<br/><div class="row-fluid sortable">
				<div class="box span12">
					...
					<h2><span class="icon icon-link"/></span> Add Testimonial</h2>
						<!--<div class="box-icon">
					...
					<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" class="form-horizontal" >
						  ...
						  <fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">Testimonial By</label>
								<div class="controls">
